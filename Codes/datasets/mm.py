...
class MM(BaseImageDataset):
    dataset_dir = '/content/drive/MyDrive/SoldierMarket1501/SOLIDER-REID/datasets/Market-1501-v15.09.15'
    ...
    def __init__(self, root='', verbose=True, pid_begin = 0, **kwargs):
        ...
        market_dir = '/content/drive/MyDrive/SoldierMarket1501/SOLIDER-REID/Market-1501-v15.09.15/bounding_box_train'
        iust_dir = '/content/drive/MyDrive/SoldierIUST/SOLIDER-REID/datasets/IUST/bounding_box_train'
        train = self.process_msmt(iust_dir)
    ...
    def process_msmt(self, msmt_dir):
        ...
        dataset = '/content/drive/MyDrive/SoldierIUST/SOLIDER-REID/datasets/IUST/bounding_box_train'
        return dataset
